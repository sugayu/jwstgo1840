...
This example works up to v0.4.4.
The critical change is that afterspec2.objmask was deprecated after v0.4.4.
Other functions may still work, but a new calib_nirspecifu.py is recommended.
This old example script helps you understand how JWSTPipelineRunner works internally.
'''
